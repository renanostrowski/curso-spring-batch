...
import com.springbatch.demonstrativoorcamentario.reader.DemonstrativoOrcamentarioRodape;
...
private LineAggregator<GrupoLancamento> lineAggregator() {
	return new LineAggregator<GrupoLancamento>() {
		...
		public String aggregate(GrupoLancamento grupoLancamento) {
			String formatGrupoOrcamentario = String.format("[%d] %s - %s\n", grupoLancamento.getCodigoNaturezaDespesa(),
			...
			String formatLancamentos = strBuilder.toString();
			return formatGrupoOrcamentario + formatLancamentos;
		}
	};
}
}
